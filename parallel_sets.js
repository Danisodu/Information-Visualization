...
d3.parsets = function() {
  ...
  function verboseTooltip(path){
    ...
    for(i in path) {
        ...
        if(path[i] == "Male" || path[i] == "Female") {
            t += "are " + path[i].toLowerCase();
        } else if(path[i] == "College graduate"){
            t+="are college graduates ";
        } else if (path[i] == "Some college credit") {
            t+="have " + path[i].toLowerCase();
        } else if(path[i] == "High school graduate") {
            t+="are high school graduates ";
        } else if (path[i] == "Less than high school"){
            t+="have less than high school education ";
        } else if(path[i] == "Unemployed"){
            t += "are " + path[i].toLowerCase();
        } else if(path[i] == "Full time" || path[i] == "Part time"){
              t += "are " + path[i].toLowerCase() + " employed";
        }
    }
  ...
  function updateDrugPS(drug) {
    drugPS = drug.toLowerCase();
  }
